...
[![License](https://img.shields.io/github/license/UKPLab/arxiv2026-grep)](https://opensource.org/licenses/Apache-2.0)
[![Python Versions](https://img.shields.io/badge/Python-3.9-blue.svg?style=flat&logo=python&logoColor=white)](https://www.python.org/)
[![CI](https://github.com/UKPLab/arxiv2026-grep/actions/workflows/main.yml/badge.svg)](https://github.com/UKPLab/arxiv2026-grep/actions/workflows/main.yml)
...
To import classes/methods of `arxiv2026_grep` from inside the package itself you can use relative imports: 
...
```py
from arxiv2026_grep import BaseClass # Notice how I omit the file name
from arxiv2026_grep.subpackage import SubPackageClass # Here it's necessary because it's a subpackage
...
This is how you can use `arxiv2026_grep` from command line:

```bash
$ python -m arxiv2026_grep
```
